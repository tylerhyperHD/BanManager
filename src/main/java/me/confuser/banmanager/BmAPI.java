...
/**
 * This is a static API for BanManager. No methods are thread safe unless stated
 * otherwise.
 * Note: The API does not handle the notifications to players nor permission
...
public class BmAPI {
    ...
    /**
     * Permanently ban a player. You must handle kicking the player if they are
     * online.
     *
    ...
    /**
     * Temporarily ban a player You must handle kicking the player if they are
     * online.
     *
     * @param player - Player to ban
     * @param actor - Who the ban is by
    ...
    /**
     * Permanently mute a player. You must handle kicking the player if they are
     * online.
     *
    ...
    /**
     * Temporarily mute a player You must handle kicking the player if they are
     * online.
     *
     * @param player - Player to mute
     * @param actor - Who the mute is by
    ...
    /**
     * Permanently ban an ip. You must handle kicking the player if they are
     * online.
     *
     * @param ban - IpBanData
     * @param silent
    ...
    /**
     * Temporarily ban an ip You must handle kicking the player if they are
     * online.
     *
     * @param ip - IP to ban, use ipToLong to convert x.x.x.x to Long
     * @param actor - Who the ban is by
    ...
    /**
     * Warn a player. You must handle the notification to the warned player
     * yourself.
     *
     * @param player
     * @param actor
    ...
    /**
     * Retrieve past warnings of a player. This method is not thread safe and
